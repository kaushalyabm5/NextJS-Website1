    ...
    <section className="relative w-full min-h-[90vh] bg-white dark:bg-black text-neutral-900 dark:text-white flex flex-col justify-center items-center px-6 py-24 overflow-hidden transition-colors duration-300">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center flex flex-col items-center">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
          ...
          <a
            href="#explore"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 bg-neutral-900 hover:bg-neutral-800 dark:bg-white dark:hover:bg-neutral-200 text-white dark:text-black font-semibold text-sm tracking-wide transition-all active:scale-95 rounded-xl shadow-lg"
          >
