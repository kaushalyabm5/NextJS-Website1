...
export default function WhoWeAre() {
  return (
    <section className="w-full bg-black text-white pt-15 pb-15 px-6 sm:px-12 flex items-center justify-center">
      <div className="max-w-5xl mx-auto text-center space-y-8">
        
        {/* MAIN MANIFESTO STATEMENT */}
        <p className="text-[2.6rem] font-medium tracking-tight text-white leading-[1.3] sm:leading-[1.25]">
